<%@ Page Title="" Language="C#" MasterPageFile="~/PersonalRoot.Master" AutoEventWireup="true" CodeBehind="PersonalWEdit.aspx.cs" Inherits="SRMS.PersonalWEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
<a href="PersonalWait.aspx">待审项目</a>
<i class="icon-angle-right"></i>
<a href="PersonalWEdit.aspx">待审编辑</a>
</asp:Content>
						  ...
						  <tbody>
							...
							<tr>
								<td class="style5" colspan="4">
                                        ...
                                        <div class="controls">
                                            <textarea id="Project_Content" class="cleditor" cols="20" name="Project_Content" runat=server 
                                                rows="3"></textarea>
                                        </div>
