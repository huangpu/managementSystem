<%@ Page Title="" Language="C#" MasterPageFile="~/ManagerRoot.Master" AutoEventWireup="true" CodeBehind="ManagerIndex.aspx.cs" Inherits="SRMS.ManagerIndex" %>
						...
						<table class="table  table-bordered " align="center">
						  ...
						  <tbody>
							<asp:Repeater ID="Repeater1" runat="server">
								...
								<td class="style1">
									 <a href="ManagerNsDetail.aspx?id=<%# Eval("News_ID") %>"><span class="label label-success">详细内容</span></a>
								</td>
							</tr>
                            </ItemTemplate>
                            <FooterTemplate>
