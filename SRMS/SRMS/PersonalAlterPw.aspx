<%@ Page Title="" Language="C#" MasterPageFile="~/PersonalRoot.Master" AutoEventWireup="true" CodeBehind="PersonalAlterPw.aspx.cs" Inherits="SRMS.PersonalAlterPw" %>
                            ...
                            <tr>
							    ...
							    <td class="style1">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                        ErrorMessage="原密码不能为空！" ControlToValidate="oldPassword"></asp:RequiredFieldValidator>
                                </td>
							</tr>
                              ...
                              <tr>
                                  ...
                                  <td class="style1">
                                      ...
                                      <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                          ...
                                          ControlToValidate="newPassword"></asp:CompareValidator>
                                  </td>
                              </tr>
                            <tr>
